...
/* package PLP-Locadora-0.1.0.0 */
#ifndef VERSION_PLP_Locadora
#define VERSION_PLP_Locadora "0.1.0.0"
#endif /* VERSION_PLP_Locadora */
#ifndef MIN_VERSION_PLP_Locadora
#define MIN_VERSION_PLP_Locadora(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_PLP_Locadora */
